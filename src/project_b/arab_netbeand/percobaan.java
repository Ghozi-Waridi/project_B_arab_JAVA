...
//       String arrkallimat ="السَّلَامُ عَلَيْكُمْم";
//       String arrkalimat_3= "ٌٍٍَُِْ";
//       String arrkalimat_2= "";
//       jTextArea1.setText(arrkallimat);
//        for (int i = 0; i< arrkallimat.length();i++) {
//            char c = arrkallimat.charAt(i);
//            if ((c!='َ') && (c!='ِ') && (c != 'ُ') && (c != 'ْ')) {
//                arrkalimat_2 += c;
//                
//            }
//
//        if(arrkalimat_3.indexOf(String.valueOf(c), 0) < 0){
//            arrkalimat_2 += c;
//        }
//
//
//          
//        jTextArea2.setText(arrkalimat_2);
//        }
